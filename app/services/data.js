...
export const services = [
  {
    ...
    headline:
      "Database Management Services in Cumming: Expert Solutions for Your Business",
    description:
      "With the advent of the digital age and the development of information technology, businesses have put a lot of dependence on their data. Regardless of the fact that it is customer data, money transactions, or vital operational data, the business success factor lies in the management and security of your database. We, Hz Group LLC, give you the best Database Management Service in Cumming, through which your data will be safe, organized, and available at the right time. We are a team of expert database understudies, who are very much skilled in managing complex database systems, which includes Oracle, PostgreSQL, and MySQL, among others. No matter if you require regular database maintenance, performance enhancement, migration, or sophisticated security solutions, we will take care of it all. We are aware that each business has its own particular database requirements and we modify our services accordingly to make your organization grow and run smoothly.",
    keyFeatures: [
    ...
    whyChooseUs:
      "Businesses in Cumming and nearby areas rely on Hz Group LLC because we consistently deliver reliable and high-performance database solutions engineered specifically to their requirements. Our personnel is devoted to offering excellent service, ensuring your data is accessible, secured, and operating at peak ability at all times.",
    icon: Palette,
    img: "/images/about.jpg",
  },
  {
    title: "Infrastructure Services in Cumming, GA",
    headline: "Building the Resilient Foundation for Your Digital Enterprise",
    description:
      "HZ Group LLC delivers comprehensive IT infrastructure services in Cumming, Georgia, designed to provide reliability, security, and scalability for modern businesses. From physical and virtual server environments to hybrid cloud architecture, high availability clustering, and proactive monitoring, we build integrated, automated infrastructure platforms that support your applications, protect your data, and scale with your growth.",
    keyFeatures: [
      "Server & Storage Solutions: Design and deployment of physical servers (Dell, HP, Cisco), virtualized environments (VMware, Hyper-V), SAN/NAS storage, and lifecycle management.",
      "Hybrid & Cloud Infrastructure: Secure integration of on-premises systems with AWS, Azure, and Google Cloud environments for flexible, scalable operations.",
      "High Availability & Clustering: Failover clustering, load balancing, and database clustering (SQL Server, Oracle, MySQL, PostgreSQL) to ensure continuous uptime.",
      "Performance & Capacity Planning: Infrastructure assessments, bottleneck analysis, right-sizing, and scalability roadmaps aligned with business growth.",
      "Security Hardening & Patch Management: CIS and NIST-aligned hardening, proactive patching, continuous monitoring, compliance support (HIPAA, PCI-DSS, SOC 2, GDPR).",
      "24/7 Monitoring & Operational Support: NOC monitoring, proactive maintenance, rapid issue resolution, structured change management, and performance reporting.",
    ],
    idealFor: [
      "Companies experiencing infrastructure instability, outages, or performance degradation.",
      "Organizations consolidating hardware through virtualization and modernization initiatives.",
      "Businesses strengthening their cybersecurity posture and compliance readiness.",
      "Internal IT teams needing expert support for complex infrastructure projects.",
      "Growing companies planning scalable infrastructure to support expansion.",
    ],
    whyChooseUs:
      "HZ Group LLC combines local Cumming, GA expertise with enterprise-level capabilities. We take a vendor-agnostic, holistic approach to infrastructure—designing integrated systems that are proactive, secure, scalable, and aligned with your business objectives. Our focus is not just on technology components, but on building resilient digital foundations that drive measurable business success.",
    icon: Storage,
    img: "/images/about.jpg",
  },
  {
    ...
    description:
      "At HZ Group LLC, we deliver enterprise-grade middleware services in Cumming, Georgia, designed to ensure your applications communicate reliably, scale effortlessly, and perform at peak efficiency. Middleware is the critical software layer connecting operating systems, databases, and user-facing applications. Our full lifecycle management approach ensures high availability, security, performance optimization, and seamless integration with modern development pipelines.",
    keyFeatures: [
      "Enterprise Platform Expertise: Installation, configuration, clustering, and lifecycle management for Oracle WebLogic, IBM WebSphere, Apache Tomcat, JBoss/WildFly, MuleSoft, and API Gateway platforms.",
      "High-Availability Architecture Design: Active-active and active-passive clustering strategies that eliminate single points of failure and meet strict recovery time objectives (RTO).",
      "Performance Optimization: Advanced JVM tuning, garbage collection optimization, thread pool configuration, connection pool management, and caching strategy improvements to maximize throughput and minimize latency.",
      "Secure Configuration & Compliance Patching: Role-based access controls, SSL/TLS enforcement, security hardening, and structured patch management aligned with PCI-DSS, HIPAA, and FISMA standards.",
      "CI/CD Pipeline Integration: Seamless middleware integration with Jenkins, GitLab CI, Azure DevOps, and other automation platforms for faster, reliable application releases.",
    ],
    idealFor: [
      "Enterprises running mission-critical Java EE and middleware-based applications that cannot tolerate downtime or performance degradation.",
      "Development and operations teams seeking improved scalability, maintainability, and infrastructure reliability.",
      "Financial institutions, healthcare providers, and government contractors requiring secure, audit-ready middleware configurations.",
      "DevOps teams aiming to automate and standardize application deployments across middleware environments.",
      "Growing technology companies in Cumming, GA and the North Atlanta metro area expanding their infrastructure.",
    ],
    whyChooseUs:
      "HZ Group LLC goes beyond standard middleware administration. Our architects design resilient, scalable middleware environments tailored to your business objectives. We integrate seamlessly with your DevOps workflows, prioritize security from day one, and provide responsive local support from our Cumming, Georgia presence while delivering enterprise-level expertise.",
    icon: Phone,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We are cloud-agnostic. We provide unbiased advice tailored to your specific technical and business needs, ensuring you choose the right platform and architecture without vendor lock-in.",
    icon: Cloud,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We act as an extension of your team. You get a dedicated account manager and direct access to veteran engineers, not a call center. Our goal is to know your environment intimately and prevent problems before they occur.",
    icon: PlayCircle,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We don't just run tests; we provide engineering insights. Our experts interpret the data to tell you *why* a bottleneck is occurring and prescribe the precise architectural or code-level changes needed to fix it.",
    icon: Brush,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "Our trainers are active consultants who face real-world technical challenges daily. They bring this invaluable frontline experience into the classroom, teaching not just the 'how' but the 'why' behind best practices.",
    icon: School,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We combine culture, process, and tooling. We don't just implement tools; we help foster a collaborative DevOps culture and design automated processes that are tailored to your organization's specific maturity level and goals.",
    icon: Code,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "Our auditors are also developers. We find vulnerabilities and, more importantly, provide actionable, developer-friendly remediation guidance to fix them effectively and prevent them from reoccurring.",
    icon: Security,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We focus on the 'why' and the 'how'. We help you identify the most valuable use cases for your business and then build the end-to-end data and model pipelines required to deploy them reliably and responsibly into production.",
    icon: TrendingUp,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We blend art and engineering. Our teams combine creative UI/UX design with robust, scalable architecture to create websites that are not only beautiful and engaging but also technically superior and built for growth.",
    icon: Web,
    img: "/images/about.jpg",
  },
  {
    ...
    headline:
      "Engineered for Engagement: Powerful Native & Cross-Platform Apps",
    description:
    ...
    whyChooseUs:
      "We are full-stack experts. Our understanding extends from the frontend UI down to the backend APIs and infrastructure, ensuring we build cohesive, performant, and reliable mobile solutions that perfectly align with your business logic.",
    icon: MobileFriendly,
    img: "/images/about.jpg",
  },
  {
    ...
    whyChooseUs:
      "We are gamers and technologists. We combine creative passion with technical mastery to build games that are not only fun and engaging but are also technically optimized for performance and scalability across target platforms.",
    icon: MobileFriendly,
    img: "/images/about.jpg",
  },
  {
  ...
  },
  {
    ...
    headline:
      "AI Adoption, Responsible Governance, and Evolving Security Threats",
    description:
  ...
  },
  {
    ...
    headline:
      "Hybrid Cloud Strategies, AI Infrastructure, and Budget Priorities",
    description:
