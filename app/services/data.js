...
export const services = [
  ...
  },
  {
    ...
    headline: "Infrastructure Services in Cumming GA: Building the Resilient Foundation for Your Digital Enterprise",
    description: "Comprehensive IT Infrastructure Solutions for Businesses in Cumming, Georgia. HZ Group LLC provides complete infrastructure solutions to businesses located in Cumming, GA to modernize and optimize on-premises and hybrid cloud environments. We design resilient, secure, and scalable systems that support applications, reduce downtime, and enable growth for organizations of all sizes.",
    keyFeatures: [
      "Holistic digital infrastructure assessments and integrated, automated designs that align servers, storage, network, backup, and cloud resources.",
      "Expertise in hybrid and public cloud migrations (AWS, Azure, Google Cloud) and optimization for performance and cost efficiency.",
      "Proactive 24/7 monitoring with AI-based analytics to detect and remediate issues before they impact operations.",
      "Physical server design and implementation using industry platforms (Dell, HP, Cisco) with redundant power, RAID, and failover configurations.",
      "Virtualized environments (VMware vSphere, Microsoft Hyper-V) and enterprise SAN/NAS storage architecture with lifecycle management.",
      "Storage optimization using deduplication, compression, tiering, and lifecycle policies to reduce costs and improve efficiency.",
      "High-availability clustering, load balancing, and application-level redundancy for continuous operations and fast failover.",
      "Performance & capacity planning with right-sizing analyses and clear scalability roadmaps tied to growth projections.",
      "Security hardening, proactive patch management, continuous security monitoring, and compliance support (HIPAA, PCI-DSS, SOC2, GDPR).",
      "Operational support including a NOC, proactive maintenance, rapid incident response, change management, and performance reporting.",
    ],
    idealFor: [
      "Companies experiencing infrastructure instability or frequent outages.",
      "Businesses consolidating and virtualizing server footprints to reduce costs and complexity.",
      "Organizations improving security posture and pursuing compliance requirements.",
      "IT teams needing expert-level support for complex infrastructure projects and operations.",
      "Growing companies planning for scale who need capacity planning and execution roadmaps.",
    ],
    whyChooseUs: "Local Cumming, GA expertise combined with enterprise capabilities — vendor-agnostic, proactive, and business-aligned infrastructure design and operations. We deliver integrated, automated, and future-proof platforms that simply work.",
    icon: Web,
  },
  {
