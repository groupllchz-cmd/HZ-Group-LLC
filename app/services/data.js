...
export const services = [
  {
    ...
    description: "With the advent of the digital age and the development of information technology, businesses have put a lot of dependence on their data. Regardless of the fact that it is customer data, money transactions, or vital operational data, the business success factor lies in the management and security of your database. We, Hz Group LLC, give you the best Database Management Service in Cumming, through which your data will be safe, organized, and available at the right time. We are a team of expert database understudies, who are very much skilled in managing complex database systems, which includes Oracle, PostgreSQL, and MySQL, among others. No matter if you require regular database maintenance, performance enhancement, migration, or sophisticated security solutions, we will take care of it all. We are aware that each business has its own particular database requirements and we modify our services accordingly to make your organization grow and run smoothly.",
    keyFeatures: [
